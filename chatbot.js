document.addEventListener('DOMContentLoaded', function() {
    ...
    // Load CSS files independently (don't wait for all)
    ...
    // Add the HTML structure immediately
    const chatbotCode = `
        <!-- Chat toggle button -->
    ...
    // Insert HTML structure into the body
    document.body.insertAdjacentHTML('beforeend', chatbotCode);

    // Function to load and initialize the main script
    const loadMainScript = () => {
        ...
        script.onload = () => {
            ...
            if (typeof window.initChatbot === 'function' && !window.chatbotInitialized) {
    ...
    // Load the main script after a short delay to ensure DOM is ready
