...
(function() {
    // First, load the required CSS files
    ...
    // Initialize chatbot after styles are loaded
    async function initializeChatbot() {
        try {
            // Load all required stylesheets first
            await Promise.all([
                loadStylesheet('https://cdn.jsdelivr.net/gh/p451/chatbot-assets@master/dist/output.css'),
                loadStylesheet('https://cdn.jsdelivr.net/gh/p451/chatbot-assets@master/src/custom.css'),
                loadStylesheet('https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css'),
                loadFont('https://fonts.googleapis.com/css2?family=Gilda+Display&display=swap')
            ]);

            // Add a namespace wrapper to prevent style conflicts
            ...
            // Load and initialize the chatbot script
